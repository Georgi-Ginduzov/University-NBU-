...
public class Main {
    public static void main(String[] args) {
        ...
        List<Detail> clothesDetails = List.of(detail1, detail2, detail3);// 'of' makes it immutable
        ...
        List<Detail> shoesDetails = List.of(detail4, detail5); // 'of' makes it
        ...
        shoesDetails.sort(detailsService.comparatorByDifficultyLevel());
    }
}